...
namespace MudDesigner.Runtime.Adapter.Telnet
{
    internal class TelnetServerTestContext
    {
        ...
        internal Mock<IConnectionFactory<TelnetServer>> ConnectionFactoryMock { get; set; }
        ...
        internal IConnectionFactory<TelnetServer> ConnectionFactory { get; set; }
        ...
        internal static TelnetServerTestContext CreateTestContext(
            ...
            Mock<IConnectionFactory<TelnetServer>> connectionFactoryMock = null,
